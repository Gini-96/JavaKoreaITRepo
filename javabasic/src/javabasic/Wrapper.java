...
public class Wrapper {
	...
	public static void main(String[] args) {
		...
		float f = 3.14f; // 4바이트 실수, 3.14는 double이므로 3.14f라고 써서
						 // 4바이트 3.14임을 알려줘야 함	대소문자의 구분은 없음
		double d = 2.1; // 8바이트 실수, 실수의 기본타입
		char c = 'A'; // 2바이트 유니코드 문자
		boolean bool = true; // 1바이트, true 또는 false 의 값만 가짐

		// Wrapper class
		// Wrapper = 기본타입의 값을 갖는 참조타입을 생성하는것 = Boxing
		...
		// i2 는 Integer타입이므로 + 연산을 위해서 i2가 가진 3을 자동으로 꺼냄
