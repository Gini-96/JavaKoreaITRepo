...
public class MathTest {
	public static void main(String[] args) {
		...
		System.out.println(Math.ceil(3.5)); // 천장값, 파라미터 보다 크지만 가장 작은 정수
		System.out.println(Math.floor(3.5)); // 바닥값, 파라미터 보다 작지만 가장 큰 정수
		System.out.println(Math.max(1.0, 2.5)); // 최대값
		System.out.println(Math.max(1.0, 2.5)); // 최소값
		System.out.println(Math.pow(2, 3)); // 2의 3승
		System.out.println(Math.random()); // 0.0 보다는 크거나 같고 1.0 보다는 작은 실수중 하나를 랜덤으로 표시
