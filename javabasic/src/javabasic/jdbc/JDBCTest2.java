...
public class JDBCTest2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 쿼리문 작성할때에 습관적으로 앞뒤에 공백을 꼭 추가해 둘것
			// 데이터베이스에 보낼 쿼리문자열
//			String insertSQL = " INSERT INTO PERSON " 
//					+ " VALUES(SEQ_PERSON.NEXTVAL, '이순신', 50) ";
//			
//			// insert, update, delete 등 select 가 아닌 sql 은 executeUpdate 호출
//			// 결과는 영향받은 행의 수를 int 로 리턴
...
//			}
			...
			// select 쿼리의 경우 executeQuery 메소드를 사용
			// 결과는 select 행들을 가리키는 거서인 ResultSet
