...
public class FlowControlStatement {
	...
	public static void main(String[] args) {
		...
		if (i1 > 5) {
			System.out.println("i1는 5보다 큽니다");
		}
		else {
			System.out.println("i1는 5보다 크지 않습니다");
		}
		...
		//실습 : for 문을 이용해서 50부터 100까지 정수중에서 3의 배수만 출력
		...
		// 무한루프에 빠지지 않도록 조건이 false 일 수 있도록 로직을 구성해야 함
		int i2 = 1;
		while (i2 < 10) {
		...
		// 실습 : while 문을 이용해서 50~100 중에서 7의 배수만 출력
		//내꺼
		int i4 = 56;
		while (i4 < 100) {
		...
		int i6 = 50;
		while (i6<=100) {
			if (i6%7 == 0) System.out.println(i6++);
		}
